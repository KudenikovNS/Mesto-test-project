...
/* Попробуем пойти через формы )) */

export const formProfile = document.querySelector(".popup__form-profile");
export const formAddCard = document.querySelector(".popup__form_card-photo");
export const formAvatar = document.querySelector(".popup__form_avatar");


export const openPopupAvatar = document.querySelector(".profile__change-avatar");
